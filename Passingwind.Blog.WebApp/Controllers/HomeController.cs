...
namespace Passingwind.Blog.WebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(PostManager postManager, CategoryManager categoryManager, TagsManager tagManager, PageManager pageManager, CommentManager commentManager, UserManager userManager, BasicSettings basicSettings, CommentsSettings commentsSettings)
        {
